...
GPSS.create_simulation(timer: 6000) do
  ...
  seize name: "STATION1"
  depart name: "LINE1"
  advance type: "normal_distribution", name: 1, mean: 335, std_dev: 60
  test_condition{ get_queue("LINE1").size < 1 }
  release name: "STATION1"
  leave name: "S1_DEVICES"
  queue name: "LINE2"
  seize name: "STATION2"
  depart name: "LINE2"
  advance type: "normal_distribution", name: 1, mean: 115, std_dev: 20
